    ...
    <div class="tab-content">
        <div id="home" class="container tab-pane active"><br>
            <form class="container">
                ...
                <div class="form-group row">
                    <label for="type" class="col-sm-2 col-form-label">种类</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="type" v-model="type">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="pixel" class="col-sm-2 col-form-label">像素</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pixel" v-model="pixel">
                    </div>
                </div>
        ...
        <div id="menu1" class="container tab-pane fade"><br>
            <form>
                ...
                <div class="form-group row">
                    <label for="type2" class="col-sm-2 col-form-label">种类</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="type2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="pixel2" class="col-sm-2 col-form-label">像素</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pixel2">
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#insertForm").click(function () {
            var url = ChengGlobal.baseUrl + "/chen/Camera/insertCamera";
            var postData = {
