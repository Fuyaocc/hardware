    ...
    <div class="tab-content">
        <div id="home" class="container tab-pane active"><br>
            <form class="container">
                ...
                <div class="form-group row">
                    <label for="suittype" class="col-sm-2 col-form-label">产品定位</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="suittype" v-model="suittype">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="account" class="col-sm-2 col-form-label">连接方式</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="account" v-model="account">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="type" class="col-sm-2 col-form-label">键盘接口</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="type" v-model="type">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="MHZ" class="col-sm-2 col-form-label">按键技术</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="MHZ" v-model="MHZ">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="aircooling" class="col-sm-2 col-form-label">背光功能</label>
                    <div class="col-sm-10">
        ...
        <div id="menu1" class="container tab-pane fade"><br>
            <form>
                ...
                <div class="form-group row">
                    <label for="suittype2" class="col-sm-2 col-form-label">产品定位</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="suittype2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="account2" class="col-sm-2 col-form-label">连接方式</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="account2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="type2" class="col-sm-2 col-form-label">键盘接口</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="type2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="MHZ2" class="col-sm-2 col-form-label">按键技术</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="MHZ2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="aircooling2" class="col-sm-2 col-form-label">背光功能</label>
                    <div class="col-sm-10">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#insertForm").click(function () {
            var url = ChengGlobal.baseUrl + "insertKeyboard";
            var postData = {
