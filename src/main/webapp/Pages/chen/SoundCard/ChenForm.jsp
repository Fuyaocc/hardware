    ...
    <div class="tab-content">
        <div id="home" class="container tab-pane active"><br>
            <form class="container">
                ...
                <div class="form-group row">
                    <label for="suittype" class="col-sm-2 col-form-label">声道系统</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="type" class="col-sm-2 col-form-label">总线接口</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="type" v-model="type">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="MHZ" class="col-sm-2 col-form-label">适用类型</label>
                    <div class="col-sm-10">
        ...
        <div id="menu1" class="container tab-pane fade"><br>
            <form>
                ...
                <div class="form-group row">
                    <label for="suittype2" class="col-sm-2 col-form-label">声道系统</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="type2" class="col-sm-2 col-form-label">总线接口</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="type2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="MHZ2" class="col-sm-2 col-form-label">适用类型</label>
                    <div class="col-sm-10">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#insertForm").click(function () {
            var url = ChengGlobal.baseUrl + "/qian/memory/add";
            var postData = {
